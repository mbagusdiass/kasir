                            ...
                            <form method="POST" action="{{ route('profile.store') }}" enctype="multipart/form-data"
                                ...
                                <label for="avatar">
                                    <a class="btn btn-primary btn-sm btn-icon-split">
                                        ...
                                        <span class="text">Change Ava</span>
                                    </a>
                                </label>
                    ...
                    <div class="col">
                        <div class="card shadow mb-3">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold">Setting User</p>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('password.update') }}">
                                    ...
                                    @if (session('status') === 'password-updated')
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            <strong>Changes password success!</strong>
                                            <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                aria-label="Close"></button>
                                        </div>
                                    @endif
                                    <div class="mb-3">
                                        <label class="form-label" for="current_password"><strong>Current
                                    ...
                                    <div class="row">
                                        <div class="col-sm col-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="password"><strong>New
                                                        Password</strong></label>
                                        ...
                                        <div class="col-sm col-12">
                                            <div class="mb-3"><label class="form-label"
                                                    for="password_confirmation"><strong>confirm
                                                        Password</strong></label>
