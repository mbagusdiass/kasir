...
<head>
    ...
    $codeprint = 'hba-' . date('d-m-Y') . add_zero_infront($sale->id, 5);
    ?>
...
<body onload="window.print()">
    ...
    <div class="text-center">
        <h2 style="margin-bottom: 5px;">Haba Store</h2>
        <p class="address">Jl. Raya Muncul Kebumen Banyubiru Kab. Semarang 50664
        </p>
    </div>
    <br>
    <div>
