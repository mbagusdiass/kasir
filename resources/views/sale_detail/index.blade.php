                    ...
                    <div class="card-header py-3">
                        <div class="row text-center text-sm-start">
                            <div class="col-sm-5 col-12 mb-3 mb-md-0">
                                <p class="text-primary m-0 fw-bold mt-2">List Product</p>
                            </div>
                ...
                <div class="card shadow mb-3">
                    ...
                    <div class="card-body">
                        <form action="{{ route('transaction.save') }}" class="saleForm" method="post">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="inputPay" placeholder="Pay" readonly>
                                <label for="inputPay">Pay</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="inputReceive"
                                    placeholder="received amount" name="received" value="0">
                                <label for="inputReceive">received amount</label>
                            </div>
                            <div class="form-floating mb-4">
                                <input type="text" class="form-control" id="inputChange" placeholder="change amount"
                                    name="change" readonly>
                                <label for="inputChange">change amount</label>
                            </div>
