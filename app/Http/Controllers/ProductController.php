...
class ProductController extends Controller
{
                ...
                <div class="d-flex justify-content-center">
                    <div class="dropdown no-arrow">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a onclick="deleteData(`'.route('product.destroy', $products->id).'`)" class="dropdown-item" href="#">Delete</a></li>
                        </ul>
                    </div>
                </div>
                ';
    ...
    public function store(Request $request)
    {
        ...
        preg_match('/HBA-0*(\d+)/', $products->code, $matches);

        $request['code'] = 'HBA-'.add_zero_infront((int) $matches[1] + 1, 6);
